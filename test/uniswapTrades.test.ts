...
import { MixedRouteTrade, MixedRouteSDK } from '@phuphamdeltalabs/router-sdk'
import { Trade as V2Trade, Pair, Route as RouteV2 } from '@phuphamdeltalabs/v2-sdk'
import { Trade as V3Trade, Route as RouteV3, Pool, FeeOptions } from '@phuphamdeltalabs/v3sdk'
